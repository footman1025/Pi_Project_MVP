...
const rows: Row[] = [
  ...
  { area: 'Opportunities catalog', kind: 'live', detail: 'Opportunity Hub: create/edit/delete (owner), skills + location/remote, search/filters, Twin-ranked cards, Apply + Connect (Messages), owner notify + inbox, public /o/:slug SEO' },
  { area: 'Opportunity Hub (market validation)', kind: 'live', detail: 'Measurable loop: Discover → View → Create/Apply → Connect → Conversation → Outcome. Traction shows created/views/applied/chats/outcomes/repeat/featured — no vanity metrics.' },
  { area: 'Featured opportunity listings', kind: 'live', detail: 'Willingness-to-pay only: owner Feature CTA → Stripe Checkout (€9 / 7 days) or honest intent if Stripe unset; pins + badge. Not a full billing system.' },
