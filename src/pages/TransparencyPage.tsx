...
const rows: Row[] = [
  ...
  { area: 'Opportunities catalog', kind: 'partial', detail: 'Opportunity Hub 0→1: create + twin-ranked catalog + Mark/Apply interest; public /o/:slug pages; Message poster when owned; Featured listing = Soon; run supabase_opportunities_hub.sql' },
  { area: 'Opportunity Hub (market validation)', kind: 'partial', detail: 'First wedge: create → discover → apply intent → message. Willingness-to-pay / featured = Soon. Ecosystem pillars stay roadmap.' },
