...
const rows: Row[] = [
  ...
  { area: 'Pi Social streams (v101)', kind: 'partial', detail: 'Opportunity Feed: Knowledge / People / Opportunities / Communities / For you; stream tags on compose; reputation signal; collaborate actions; share + report' },
  { area: 'Universal Generational Experience', kind: 'partial', detail: '/experience — text scale, density, high contrast, reduce motion, simplified nav, life-stage hint (device prefs; account sync later)' },
  { area: 'Trust & Safety / Truth Guarantee', kind: 'partial', detail: '/trust principles page; content reports v0 (local + supabase_content_reports.sql); full AI moderation / E2E / LE portal = Soon' },
